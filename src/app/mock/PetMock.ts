...
export class PetMock {
  ...
  private mockPets: Pet[] = [
    ...
    { id: this.generateRandomId(), nome: 'Mia', idade: '3 anos', genero: 'fêmea', raca: 'Dachshund', porte: Porte.Pequeno, castrado: true, temperamento: 'dócil', adotado: false, foto: '../assets/pets/dachshund_mia.jpg' },
    ...
    { id: this.generateRandomId(), nome: 'Oscar', idade: '2 anos', genero: 'macho', raca: 'Schnauzer', porte: Porte.Pequeno, castrado: false, temperamento: 'leal', adotado: true, foto: '../assets/pets/Schnauzer_oscar.jpg' },
    ...
    { id: this.generateRandomId(), nome: 'Charlie', idade: '4 anos', genero: 'macho', raca: 'Cocker Spaniel', porte: Porte.Medio, castrado: true, temperamento: 'afetuoso', adotado: true, foto: '../assets/pets/cocker_charlie.jpg' }
  ];
